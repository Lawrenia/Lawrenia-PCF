...
const EditRecipe = () => {
  ...
  const addIngredient = () => {
    ...
    if (formDetails.ingredients.includes(ingredient)) {
                  ...
                  <ul className="flex flex-col gap-2">
                    {formDetails.ingredients.map((ele, index) => (
                      ...
                      >
                        ...
                        size={20}
                        onClick={() => deleteIngredient(index)} // Call deleteIngredient function with the index of the ingredient
                        />
                      </li>
                    ))}
                  </ul>
                    ...
                    >
                      ...
                      <div>
                        <RxCross2
                          ...
                          size={20}
                          onClick={() => deleteInstruction(i)} // Call deleteInstruction function with the index of the instruction
                        />
                      </div>
                    </li>
                  ))}
